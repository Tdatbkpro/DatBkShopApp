        ...
        httpSecurity.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests((requests) -> {
                    requests.requestMatchers(
                            ...
                            .requestMatchers(DELETE, String.format("%s/orders/**", apiPrefix)).hasAnyRole(Role.USER , Role.ADMIN)
                            .requestMatchers(PUT, String.format("%s/orders/**", apiPrefix)).hasAnyRole(Role.USER , Role.ADMIN)
